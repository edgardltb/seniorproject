...
abstract class Schedule implements ActiveRecordInterface
{
    ...
    public function setScheduleId($v)
    {
        ...
        if ($this->schedule_id !== $v) {
            $this->schedule_id = $v;
            $this->modifiedColumns[ScheduleTableMap::COL_SCHEDULE_ID] = true;
        }
    ...
    public function setMentorId($v)
    {
        ...
        if ($this->mentor_id !== $v) {
            $this->mentor_id = $v;
            $this->modifiedColumns[ScheduleTableMap::COL_MENTOR_ID] = true;
        }
    ...
    public function setCustomerId($v)
    {
        ...
        if ($this->customer_id !== $v) {
            $this->customer_id = $v;
            $this->modifiedColumns[ScheduleTableMap::COL_CUSTOMER_ID] = true;
        }
    ...
    public function setRoom($v)
    {
        ...
        if ($this->room !== $v) {
            $this->room = $v;
            $this->modifiedColumns[ScheduleTableMap::COL_ROOM] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ScheduleTableMap::translateFieldName('CustomerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->customer_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ScheduleTableMap::translateFieldName('Room', TableMap::TYPE_PHPNAME, $indexType)];
            $this->room = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = ScheduleTableMap::NUM_HYDRATE_COLUMNS.
    ...
    {
        if ($this->aMentor !== null && $this->mentor_id !== $this->aMentor->getMentorId()) {
            $this->aMentor = null;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ScheduleTableMap::COL_CUSTOMER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'Customer_id';
        }
        if ($this->isColumnModified(ScheduleTableMap::COL_ROOM)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'Customer_id':
                        ...
                        break;
                    case 'room':
                        $stmt->bindValue($identifier, $this->room, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ScheduleTableMap::COL_CUSTOMER_ID)) {
            $criteria->add(ScheduleTableMap::COL_CUSTOMER_ID, $this->customer_id);
        }
        if ($this->isColumnModified(ScheduleTableMap::COL_ROOM)) {
            $criteria->add(ScheduleTableMap::COL_ROOM, $this->room);
        }
    ...
    {
        $validPk = null !== $this->getScheduleId() &&
            null !== $this->getMentorId() &&
            null !== $this->getCustomerId();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation fk_schedule_Customer1 to table customer
        ...
        //relation fk_schedule_Mentor1 to table mentor
        if ($this->aMentor && $hash = spl_object_hash($this->aMentor)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }
    ...
    {
        $pks = array();
        $pks[0] = $this->getScheduleId();
        $pks[1] = $this->getMentorId();
    ...
    {
        $this->setScheduleId($keys[0]);
        $this->setMentorId($keys[1]);
    ...
    {
        return (null === $this->getScheduleId()) && (null === $this->getMentorId()) && (null === $this->getCustomerId());
    }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setScheduleId(NULL); // this is a auto-increment column, so set to default value
        }
    }
    ...
    public function getCustomer(ConnectionInterface $con = null)
    {
        if ($this->aCustomer === null && ($this->customer_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCustomer->addSchedules($this);
             */
        }
    ...
    public function setMentor(ChildMentor $v = null)
    {
        if ($v === null) {
            ...
            $this->setMentorId($v->getMentorId());
        }
    ...
    {
        if ($this->aMentor === null && ($this->mentor_id != 0)) {
            $this->aMentor = ChildMentorQuery::create()->findPk($this->mentor_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMentor->addSchedules($this);
             */
        }
    ...
    {
        if (null !== $this->aCustomer) {
            $this->aCustomer->removeSchedule($this);
        }
        if (null !== $this->aMentor) {
