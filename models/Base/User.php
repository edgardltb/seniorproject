...
abstract class User implements ActiveRecordInterface
{
    ...
    public function setCreateTime($v)
    {
        ...
        if ($this->create_time !== null || $dt !== null) {
            if ($this->create_time === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->create_time->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[UserTableMap::COL_CREATE_TIME] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UserTableMap::translateFieldName('CreateTime', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_CREATE_TIME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_CREATE_TIME)) {
            $criteria->add(UserTableMap::COL_CREATE_TIME, $this->create_time);
        }
