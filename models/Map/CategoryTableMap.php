...
class CategoryTableMap extends TableMap
{
     ...
     */
    const COL_CATEGORIE_ID = 'category.categorie_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('CategorieId', 'Name', 'Description', ),
        self::TYPE_CAMELNAME     => array('categorieId', 'name', 'description', ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_CATEGORIE_ID, CategoryTableMap::COL_NAME, CategoryTableMap::COL_DESCRIPTION, ),
        self::TYPE_FIELDNAME     => array('categorie_id', 'name', 'description', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('CategorieId' => 0, 'Name' => 1, 'Description' => 2, ),
        self::TYPE_CAMELNAME     => array('categorieId' => 0, 'name' => 1, 'description' => 2, ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_CATEGORIE_ID => 0, CategoryTableMap::COL_NAME => 1, CategoryTableMap::COL_DESCRIPTION => 2, ),
        self::TYPE_FIELDNAME     => array('categorie_id' => 0, 'name' => 1, 'description' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('categorie_id', 'CategorieId', 'INTEGER', true, null, null);
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CategoryTableMap::COL_CATEGORIE_ID);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CategoryTableMap::COL_CATEGORIE_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(CategoryTableMap::COL_CATEGORIE_ID) && $criteria->keyContainsValue(CategoryTableMap::COL_CATEGORIE_ID) ) {
