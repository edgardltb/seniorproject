...
class AdministratorTableMap extends TableMap
{
  ...
  array (
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(AdministratorTableMap::COL_ADMIN_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(AdministratorTableMap::COL_ADMIN_ID) && $criteria->keyContainsValue(AdministratorTableMap::COL_ADMIN_ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.AdministratorTableMap::COL_ADMIN_ID.')');
        }
