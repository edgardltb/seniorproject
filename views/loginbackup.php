...
<div class="row">
        <div class="col-md-4 col-sm-6 col-xs-6 col-lg-11">
          <div class="thumbnail">
...
<div class="caption">
  ...
  <div><h3>Login</h3>
    ...
    <div class="input-group input-group-lg"><span class="input-group">UserName</span>
      <input type="text" class="form-control" placeholder="User Name" name="username">
    </div>
    <div class="input-group input-group-lg"><span class="input-group">Password</span>
...
<hr>
        ...
        <p class="text-center"><a href="#" class="btn btn-success" role="button" type="submit">Enter</a></p>
