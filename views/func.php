...
function customerCheck( $sql)
{
    echo "<table class='table table-hover col-2'>";

    echo "<thead><tr><th scope='col'>Check</th><th scope='col'>ID</th><th scope='col'>Name</th><th scope='col'>Phone</th><th scope='col'>Membership</th><th scope='col'>Username</th></tr></thead> <tbody>";
    foreach ($sql as $row) {
        echo "<tr data=" . $row->getID() . " name='customers' class='rowClick'>";

        echo "<th class='notselect'><input type='checkbox' name='items[]' value='".$row->getId()."'></th><th >" . $row->getId() . "</th id = $row-->> <th>" . $row->getName() . "</th> <th> " . $row->getPhone() . "</th> <th>" . $row->getMembership() . "</th> <th>" . $row->getUserName() . "</th>";
        echo "</tr>";
...
function employeeCheck($sql)
{
    echo "<table class='table table-hover col-2'>";



    echo "<thead><tr><th scope='col'>Check</th><th scope='col'>ID</th><th scope='col'>Name</th><th scope='col'>City</th><th scope='col'>State</th><th scope='col'>Position</th><th scope='col'>Salary</th></tr></thead><tbody>";
    foreach ($sql as $row) {
        echo "<tr data=" . $row->getID() . " name='employees' class='rowClick'>";
         echo "<th class='notselect'><input type='checkbox' name='items[]' value='".$row->getId()."'></th><th>" . $row->getId() . "</th> <th>" . $row->getName() . "</th> <th> " . $row->getCity() . "</th> <th>" . $row->getState() . "</th> <th>" . $row->getPosition()->getName() . "</th>
				<th>" . $row->getSalary() . "</th> ";
        echo "</tr>";
...
function itemsCheck($sql)
{
    ...
    echo "<thead><tr><th scope='col'>Check</th><th scope='col'>ID</th><th scope='col'>Name</th><th scope='col'>Description</th><th scope='col'>Price</th></tr></thead><tbody>";
    foreach ($sql as $row) {
        echo "<tr data=" . $row->getID() . " name='item'>";
        echo "<th class='notselect'><input type='checkbox' name='items[]' value='".$row->getId()."'></th><th>" . $row->getId() . "</th> <th>" . $row->getName() . "</th><th> " . $row->getDescription() . "</th> <th>" .$row->getCategorie()->getName(). "</th><th>" . $row->getPrice() . "</th>";
        echo "</tr>";
...
function storesCheck($sql)
{
    echo "<table class='table table-hover col-2'>";

    echo "<thead><tr><th scope='col'>Check</th><th scope='col'>ID</th><th scope='col'>Phone</th><th scope='col'>Lcation</th><th scope='col'>Address</th></tr></thead><tbody>";
    foreach ($sql as $row) {
        echo "<tr data=" . $row->getID() . " name='stores' class='rowClick'>";
        echo "<th class='notselect'><input type='checkbox' name='items[]' value='".$row->getId()."'></th><th>" . $row->getId() . "</th> <th>" . $row->getPhone() . "</th><th> " . $row->getLocation() . "</th><th> " . $row->getAddress() . "</th>";
        echo "</tr>";
    }
    echo"</tbody></table>";
}
